...
class OrganizationClientQuerySerializer(serializers.Serializer):
    ...
    min_age = serializers.IntegerField(default=0, help_text="Edad mínima del cliente que se quiere obtener")
    max_age = serializers.IntegerField(default=999, help_text="Edad máxima del cliente que se quiere obtener")
